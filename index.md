...
This was a school project. It's a very basic full-stack CRUD project. It uses MongoDB with a provided stock database as its basis, interacts with the MongoDB with Python (Pymongo) code, builds a RESTful API on top of it with Python and Bottle, and then accesses it from a browser via HTML and asynchronous Javascript.
